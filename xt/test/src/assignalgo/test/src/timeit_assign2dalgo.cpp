...
int main(int argc, char const *argv[])
{
    ...
    costMatrix = xt::random::rand<double>({50, 50});
#endif
    ...
    // assignauction
    {
        ...
        std::tie(assignments, unassignedTracks, unassignedDetections) = assignalgo::assignauction(costMatrix, costOfNonAssignment);
        ...
        std::cout << "Time taken by assignauction: "
    ...
    // assignjv
    {
        ...
        auto start = std::chrono::high_resolution_clock::now();
        std::tie(assignments, unassignedTracks, unassignedDetections) = assignalgo::assignjv(costMatrix, costOfNonAssignment);
        auto stop = std::chrono::high_resolution_clock::now();
    ...
    // assignmunkres
    {
        ...
        auto start = std::chrono::high_resolution_clock::now();
        std::tie(assignments, unassignedTracks, unassignedDetections) = assignalgo::assignmunkres(costMatrix, costOfNonAssignment);
        auto stop = std::chrono::high_resolution_clock::now();
        ...
        std::cout << unassignedTracks << std::endl;
        std::cout << unassignedDetections << std::endl;
        std::cout << "Time taken by assignmunkres: "
                  << std::fixed << std::setprecision(9)
                  << duration << " s" << std::endl
                  << std::endl;
    }
    // assignmunkres_fast
    {
        ...
        auto start = std::chrono::high_resolution_clock::now();
        std::tie(assignments, unassignedTracks, unassignedDetections) = assignalgo::assignmunkres_fast(costMatrix, costOfNonAssignment);
        auto stop = std::chrono::high_resolution_clock::now();
        ...
        std::cout << unassignedTracks << std::endl;
        std::cout << unassignedDetections << std::endl;
        std::cout << "Time taken by assignmunkres_fast: "
                  << std::fixed << std::setprecision(9)
                  << duration << " s" << std::endl
                  << std::endl;
    }
