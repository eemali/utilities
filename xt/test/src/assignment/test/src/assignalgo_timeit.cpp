...
int main(int argc, char const *argv[])
{
    ...
    double costOfNonAssignment = 0.2;
    {
        ...
        assignalgo::assignauction(costMatrix, costOfNonAssignment, assignments, unassignedTracks, unassignedDetections);
    ...
    }
    {
        ...
        auto start = std::chrono::high_resolution_clock::now();
        assignalgo::assignjv(costMatrix, costOfNonAssignment, assignments, unassignedTracks, unassignedDetections);
        auto stop = std::chrono::high_resolution_clock::now();
    ...
    }
    {
        ...
        auto start = std::chrono::high_resolution_clock::now();
        assignalgo::assignmunkres(costMatrix, costOfNonAssignment, assignments, unassignedTracks, unassignedDetections);
        auto stop = std::chrono::high_resolution_clock::now();
