...
namespace assignalgo
{
    ...
    static xt::xarray<size_t> getSolution(xt::xarray<double> costMatrix,
                                          algFcn_t algFcn,
                                          double *cost = nullptr,
                  ...
                  algFcn_t algFcn)
    {
        ...
        while (currentGap > desiredGap && currentIter - 1 < maxIterations)
        {
            ...
            for (size_t i = 0; i < numConstraints; ++i)
            {
                ...
                {
                    matrix = constrainedCost[i - 1] - lagrangianMultipliers.at(i);
                }
            ...
            for (int i = numConstraints - 1; i >= 0; --i)
            {
                ...
                enforcedConstraint = getSolution(feasibleCostMatrix, algFcn, nullptr, &price.at(i));
            ...
            bool updateSolution = bestFeasibleCost.at(0) == feasibleCost.at(0);
                                                          ...
                                                          const xt::xarray<size_t> &assignments)
    {
        ...
        size_t currentDim = costMatrix.shape().size() - 1;
                                                        ...
                                                        const xt::xarray<size_t> &assignments)
    {
        ...
        size_t currentDim = sortedIndices.shape().size();
    ...
    {
        return assign2DRelaxed(costMatrix, algFcn, cost, price);
    }
